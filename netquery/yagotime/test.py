...
# load model
if args.load_model:
	trainer.load_model_1('G:\\xubing\\14time\se-kge-master\graphqa\model_dir\\time_period_newdata\\2024-03-31-11-15-59time_period_new_global.pth')
